...
// Province
Breadcrumbs::for('admin.provinces.index', function (BreadcrumbTrail $trail): void {
    $trail->parent('admin.index');
    $trail->push('Provinces', route('admin.provinces.index'));
});
// Assigned Polio Workers
Breadcrumbs::for('admin.workers.index', function (BreadcrumbTrail $trail): void {
    $trail->parent('admin.index');
    $trail->push('Assign Polio Workers', route('admin.workers.index'));
});
// Assigned Union Councils
Breadcrumbs::for('admin.assigned_union_councils.index', function (BreadcrumbTrail $trail): void {
    $trail->parent('admin.index');
    $trail->push('My Assigned Councils', route('admin.assigned_union_councils.index'));
});
// profile
